                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="duration" id="duration" class="form-control" value="{{ old('duration', $project->duration) }}" required>
                                                @error('duration')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="end_date" id="end_date" class="form-control" value="{{ old('end_date', $project->end_date) }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="estimated_cost" class="form-control" value="{{ old('estimated_cost', $project->estimated_cost) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="payment_terms" class="form-control">
                                                    <option value="full_advance" {{ old('payment_terms', $project->payment_terms) == 'full_advance' ? 'selected' : '' }}>Full Advance</option>
                                                    <option value="milestone_based" {{ old('payment_terms', $project->payment_terms) == 'milestone_based' ? 'selected' : '' }}>Milestone Based</option>
                                                    <option value="monthly" {{ old('payment_terms', $project->payment_terms) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
